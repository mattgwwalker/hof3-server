    ...
    def editMembrane(self, request):
        ...
        def edit():
            ...
            def writeToDatabase(cursor):
                ...
                cursor.execute("UPDATE Membranes SET Name=?, Description=?, MWCO=?, Retired=?, MaxInletPressure=?, MaxAlongMembranePressure=?, MaxTransMembranePressure=?, MaxBackPressure=?, MinTemperature=?, MaxTemperature=?, MinPH=?, MaxPH=? WHERE MembraneID = ?", (args["name"], args["description"], args["mwco"], args["retired"], args["maxInletPressure"], args["maxAlongMembranePressure"], args["maxTransMembranePressure"], args["maxBackPressure"], args["minTemperature"], args["maxTemperature"], args["minPH"], args["maxPH"], args["membraneID"]))
